...
* Go to <https://github.com/the-holocron/animate/pulls> and open a new pull request with your changes and fill out the template with the appropriate information.
